...
public class RemoteRepository {
    ...
    public void getDetails(MovieEntity movieEntity, Constants.Category category,
                           RemoteDBHelper.DetailsListener listener){
        remoteDBHelper.loadDetails(movieEntity, category, listener);
    }
}
